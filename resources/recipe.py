...
class RecipeListResource(Resource) : # 클래스 소괄호는 상속한다는 의미이다.
    ...
    def post(self) :
        ...
        # 아래 함수는 토큰에서, 토큰만들때 사용한 데이터를 복호화해서 바로 가져다 준다.
        # 유저테이블의 id로 암호화 했으니까 복호화 하면 다시 유저 아이디를 받아올 수 있다.
...
class RecipeResource(Resource) :
    ...
    def get(self, recipe_id) :
        ...
        # 1. 클라이언트로부터 데이터를 받아온다. 이미 경로에 들어있는, 레시피 아이디를 받아왔다.
